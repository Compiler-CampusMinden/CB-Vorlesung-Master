...
[Nested Scopes: Eigene Modellierung nach einer Idee in [@Parr2010, p. 142]]{.origin nolist=true}
...
[Nested Scopes: Eigene Implementierung nach einer Idee in [@Parr2010, p. 169]]{.origin nolist=true}

...
[Konsole: pandoc [hello.md](https://github.com/Compilerbau/Lecture/blob/master/markdown/intermediate/src/hello.md) -s -t native]{.bsp}
...
[Beispiel: clang -emit-llvm -S -o - [hello.c](https://github.com/Compilerbau/Lecture/blob/master/markdown/intermediate/src/hello.c)]{.bsp}
...
[Beispiel: python -m dis [hello.py](https://github.com/Compilerbau/Lecture/blob/master/markdown/intermediate/src/hello.py)]{.bsp}
...
[Beispiel: javac [Hello.java](https://github.com/Compilerbau/Lecture/blob/master/markdown/intermediate/src/Hello.java) && javap -c  Hello.class]{.bsp}
...
[Beispiel: gcc -S -o - [hello.c](https://github.com/Compilerbau/Lecture/blob/master/markdown/intermediate/src/hello.c)]{.bsp}
